...
const UnsolvedProblemsTab: React.FC<UnsolvedProblemsTabProps> = ({ username }) => {
    const { data: responseData, error, isLoading } = useSWR(`/api/profile/problems/unsolved?username=${username}`, fetcher);
